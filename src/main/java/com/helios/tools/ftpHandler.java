...
public class ftpHandler {
	...
	public static void main(String server, String user, String pass, String fileLocation) {
		server = "localhost";
		int port = 21;
		user = "User1";
		pass = "pass";
		...
		try {
			...
			// // APPROACH #2: uploads second file using an OutputStream - not
			// working for some reason

			// File secondLocalFile = new File("D:/test2.txt");
			// String secondRemoteFile = "test/test2.txt";
